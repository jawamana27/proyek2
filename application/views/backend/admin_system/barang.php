                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <div class="text-right">
                      ...
                      <a class="btn btn-success btn-add" href="<?php echo base_url('admin_system/barang_form') ?>">
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            <form action="<?php echo base_url('admin_system/barang_form') ?>" method="post">
										          ...
										          <button class="btn btn-info btn-xs btn-edit" type="submit" data-original-title="Ubah" 
                              data-placement="top" data-toggle="tooltip"><i class="fa fa-edit"></i></button>
								 	          </form>
                          </td>
                          <td class="text-center">
                            <form action="<?php echo base_url('admin_system/barang_delete') ?>" method="post">
                              ...
                              data-placement="top" data-toggle="tooltip"><i class="fa fa-trash-o"></i></button>
								 	          </form>
                          </td>
                        </tr>
                        <?php } ?>
